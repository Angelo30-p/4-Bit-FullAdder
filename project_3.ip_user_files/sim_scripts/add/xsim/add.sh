...
#
# Script generated by Vivado on Sat Dec 13 22:54:11 +0530 2025
...
#
# Usage        : add.sh
#                add.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                add.sh [-rerun]
#                add.sh [-reset_run]
#                add.sh [-clean]
#                add.sh [-reset_log]
...
export RDI_DATADIR="E:/2025.2/Vivado/data"
...
# script info
echo -e "add.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./add.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_15 -L c_reg_fd_v12_0_11 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_11 -L c_addsub_v12_0_21 -L secureip -L xpm --snapshot add xil_defaultlib.add -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb add.wdb xsim.dir libdpi.so)
...
Usage: add.sh [-clean]\n\
Usage: add.sh [-reset_log]\n\
Usage: add.sh [-keep_index]\n\
